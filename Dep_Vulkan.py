...
#gets the include directory
VOLK_INCLUDE_DIR = "Venders/Volk/"

#lists all the files we need to include
VOLK_SOURCE_FILE_NAMES = [
	"volk.c",
	"volk.h"
]

#adds the source paths to the source list in a Premake project
def AddSources_Volk(srcs):
	for f in VOLK_SOURCE_FILE_NAMES:
		srcs.append(VOLK_INCLUDE_DIR + "/" + f)
...
def GetDep_VulkanLibraries():
	...
	GitOperations.GitClone("https://github.com/zeux/volk.git", "Volk")